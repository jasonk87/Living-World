...
class SharePositiveNewsAction(Action):
    """An action for a character to share positive news with another."""
    ...
    def execute(self, world: World) -> ActionStatus:
        ...
        dialogue_line_self = "Heard the hunters had a good catch today!"
        dialogue_line_target = "Oh, that's good to hear!"
        ...
        world.add_event_log_message(f"{self.character.name} shared some news with {self.target_name}.")
